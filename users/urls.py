...
RegisterAPIView, SignalProviderProfileAPIView, AssestAPIView, AssetBasedSignalProviderPostAPIView, LoginAPIView
...
urlpatterns = [
    ...
    path('update_user_profile/', csrf_exempt(UserProfileAPIView.as_view()), name='user_profile'),
    path('update_signal_provider_profile/', SignalProviderProfileAPIView.as_view(), name='signal_provider_profile'),
    path('get_user_profile/', csrf_exempt(UserProfileAPIView.as_view()), name='get_user_profile'),
